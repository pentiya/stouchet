...
urlpatterns = [
    ...
    path('road/table/', views.RoadTableView.as_view(), name='road_table'),
    path('road/add/', views.RoadCreateView.as_view(), name='road_add'),
    path('road/<int:pk>', views.RoadDetailView.as_view(), name='road_detail'),
